 ...
 */
@Component
public class MultiplyDatasourceTransactionInterceptorReplacer implements BeanFactoryPostProcessor {
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory factory) throws BeansException {
		...
		for (String name : names) {
			...
			bd.setBeanClassName(MultiplyDatasourceTransactionInterceptor.class.getName());
		}
	}
}
