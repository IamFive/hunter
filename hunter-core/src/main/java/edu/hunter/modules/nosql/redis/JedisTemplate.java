package edu.hunter.modules.nosql.redis;
...
/**
 * 供了一个template方法，负责对Jedis连接的获取与归还。
...
public class JedisTemplate {
	...
	public JedisTemplate(String host, Integer port, int timeout, int thead) {
		this.jedisPool = JedisUtils.createJedisPool(host, port, timeout, thead);
	}
